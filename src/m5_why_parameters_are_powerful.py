...
def main():
    ...
    #even_better_draw_circles(rg.Point(100, 50), 15, 15, 'red', 5)
    #even_better_draw_circles(rg.Point(-200,0), 30, 5, 'blue', 2)

    #Below just creates a bunch of random circles that don't look terrible together.
    even_better_draw_circles(rg.Point(100,50), 10, 20, 'yellow', 3)
    even_better_draw_circles(rg.Point(-100,50), 10, 20, 'yellow', 3)
    even_better_draw_circles(rg.Point(0, 150), 10, 20, 'yellow', 3)
    even_better_draw_circles(rg.Point(0, -50), 10, 20, 'yellow', 3)
    even_better_draw_circles((rg.Point(0,50)), 10, 20, 'red', 3)
...
def even_better_draw_circles(point,radi,n,col,thck):

    turtle = rg.SimpleTurtle()
    turtle.pen = rg.Pen(col,thck)
