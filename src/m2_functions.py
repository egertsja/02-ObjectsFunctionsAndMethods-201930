...
#
###############################################################################
def color_line(cl,thck):

    turtle1 = rg.SimpleTurtle()
    turtle1.pen = rg.Pen('green',thck)

    turtle2 = rg.SimpleTurtle()
    turtle2.pen = rg.Pen(cl, 5)

    turtle1.forward(100)
    turtle2.backward(100)
#Window closing causes error code and thus was removed for now. Rest of function works without it.
